# Sealed Bid Auctions for ERC-721 Tokens

Chainlink Hackathon Spring 2022 project. Here you will find the implementation of a sealed bid auction protocol for ERC-721 tokens that uses chainlink keepers to automate auction execution.
...
The frotend is available on the following [link](https://sealed-bid-auctions.netlify.app/). You need Rinkeby eth to run and participate in auctions. 
...
#### When do reveals end?
* Reveals end at the set time + 2 minutes. This 2 minutes let the auctioneer reveal his minimum price. But do not worry, if he does not reveal the price then it will be set to 0 and the auction will continue. 
